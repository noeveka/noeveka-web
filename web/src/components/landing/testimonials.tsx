...
const AzureSvg = () => (
    <svg width="22" height="22" viewBox="0 0 96 96" role="img" aria-label="Azure">
        ...
        <path
            fill="url(#az-grad)"
            d="M34.93 6.27L9.12 74.42H29.2l21.23-47.29 16.21 33.73H48.82L41.7 74.42H86.88L55.41 6.27Z"
        />
    </svg>
);
...
const SnowflakeSvg = () => (
    <svg width="20" height="20" viewBox="0 0 24 24" fill="none"
        stroke="#29B5E8" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"
        role="img" aria-label="Snowflake"
    >
...
function StarRating({ n }: { n: number }) {
    return (
        <div className="flex items-center gap-0.5">
            ...
            <span className="ml-1.5 text-[11.5px] font-bold" style={{ color: "var(--color-brand)" }}>
                {n}.0
            </span>
        </div>
    );
...
export default function Testimonials() {
    return (
        <>
            ...
            >
                <div
                    className="lp-container lp-px py-5 grid grid-cols-5 divide-x"
            ...
            >
                <div className="lp-container lp-px py-16 lg:py-20">
                    ...
                    <div className="text-center mb-12">
                        <motion.p
                            {...fu()}
                            className="inline-flex items-center gap-1.5 text-[10.5px] font-bold tracking-[0.2em] uppercase mb-3"
                        ...
                        <motion.h2
                            {...fu(0.07)}
                            className="text-3xl sm:text-[2.2rem] font-extrabold tracking-tight mb-4"
                            style={{ color: "var(--color-text-primary)" }}
                        >
                        ...
                        >
                            Real enterprise leaders sharing their experience with Noeveka&apos;s
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
                        {TESTIMONIALS.map(({ company, abbr, quote, name, role, rating }, i) => (
                            <motion.div
                                key={name}
                                {...fs(0.06 + i * 0.10)}
                                ...
                                style={{
                                    ...
                                    boxShadow: "0 4px 24px rgba(15,17,23,0.06)",
                                }}
                            >
                                {/* Top row: quote mark + company badge */}
                                <div className="flex items-start justify-between mb-5">
                                    <span
                                        className="text-[52px] font-extrabold leading-none select-none"
                                        style={{ color: "var(--color-brand)", lineHeight: 1, marginTop: -6 }}
                                    >
                                        &quot;
                                    </span>
                                    <div className="flex items-center gap-2">
                                        <div
                                            ...
                                            style={{
                                                ...
                                                border: "1px solid rgba(246, 93, 1, 0.22)",
                                            }}
                                        >
                                            {abbr}
                                        </div>
